...
const submissionSchema = new Schema({
  challenge: { type: Schema.Types.ObjectId, ref: 'WritingChallenge', required: true, index: true },
...
submissionSchema.index({ challenge: 1, user: 1, attemptNumber: 1 }, { unique: true });
